...
public class OutputFile {
   ...
   private void writeDocFooter() throws IOException {
      Object[] args = { OxDoc.ProductName, OxDoc.Version, _fileName, OxDoc.Url };

      writeln(MessageFormat.format("<div class=\"footer\">Generated by <a href=\"{3}\">{0} {1}</a> &copy Copyright 2005-2010 by Y. Zwols" + "<br>\nOriginal filename: <tt>{2}</tt></div>", args));
   }
}
